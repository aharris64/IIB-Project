"""Step 8 (terminal/standalone, superseded): KDE/histogram plots of candidate
properties (contrast, response, weighted score) by manual rating, on the
un-reclassified combined-candidates data — earlier, simpler sibling of
09_plot_best_candidate_properties.py; kept for history, not the one to use going
forward."""
